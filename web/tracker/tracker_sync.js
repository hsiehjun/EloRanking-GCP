          ...
          <div style="background:rgba(15, 23, 42, 0.7); border:1px solid rgba(192, 132, 252, 0.35); border-radius:12px; padding:12px 16px;">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:10px;">
              ${availableEnhancements.map(enh => `
                <div style="background:#070b14; border:1px solid rgba(255,255,255,0.06); border-radius:8px; padding:10px; display:flex; flex-direction:column; gap:6px;">
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                    <b style="font-size:12px; color:#fff; font-family:'JetBrains Mono',monospace;">✨ ${escapeHtml(enh.name || '')}</b>
                      ...
                      <div style="display:flex; flex-direction:column; gap:4px;">
                        ...
                        ${enhName ? `
                          <div style="background:rgba(192,132,252,0.12); border:1px solid rgba(192,132,252,0.3); border-radius:6px; padding:6px 8px; font-size:10px;">
                            ...
                            ${enhDesc ? `<span style="color:#e2e8f0; line-height:1.4;"> ${escapeHtml(enhDesc)}</span>` : '<span style="color:#94a3b8; font-style:italic;"> Detachment enhancement assigned to this character</span>'}
                          </div>
                        ` : ''}
                        ${abilities.map(ab => `
